...
<div class="content-fluid ">
  <div class="row">
    <div class="col-sm-8">
      <h2>About Us</h2>
      <h4 style="font-size:19px;font-family:Geneva;">We the members of Taste The Best have taken a pledge to provide the customers with best quality food. We are here to satisfy their needs and taste.</h4>      
      ...
      This brings all necessities in one place that benefits both the user and the restaurant owner smartly..</p><br>
...
<div class="container-fluid text-center bg-grey">
  ...
  <div class="row">
    ...
    <div class="col-sm-6">
      ...
      <p style="font-size:17px;">At our core Taste The Best operates on imagination ,<br> individuality, inclusively and impact </p>
    </div>

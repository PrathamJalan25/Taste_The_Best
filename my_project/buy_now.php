	  ...
	  <?php
		...
		if(isset($_REQUEST['place_order']))
		{
			...
			if(isset($_REQUEST['save']))
			{
				...
				$upd="update users set flat='$flat',street='$street',landmark='$landmark',city='$city',state='$state',pincode='$pincode',name='$name',mobile_no='$mobile' where user_name='$user_name'";
